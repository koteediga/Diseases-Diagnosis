...
function Services() {
    const redirectToPage = () => {
        window.location.href = 'C:/Users/chandra%20sekhar/OneDrive/Desktop/medicure-template/predict.html';
    }
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="cv-feature-box">
                                ...
                                <div className="cv-feature-text">
                                    <a className="fs-4 text-dark fw-bold" onClick={redirectToPage}>Disease Diagonisis</a>
